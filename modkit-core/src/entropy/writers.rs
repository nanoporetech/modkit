...
const WINDOWS_HEADER: &'static str = "\
        #chrom\tstart\tend\tentropy\tstrand\tnum_reads\tmean_methylation_level\tstd_methylation_level\tcount_methylated\ttotal_calls\tnumber_of_states\tnumber_of_positions\n";
